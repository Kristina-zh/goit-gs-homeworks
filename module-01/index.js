...
// console.log(`Выбран "Генератора защитного кода", цена за штуку ${price} кредитов`); 
...
// const userInput = prompt('How many droids do you want to buy?');
// if(userInput === null){
//   console.log('Отменено пользователем!');
// } 
// else {
//   if(pricePerDroid * userInput <= credits) {
//     credits -= pricePerDroid * userInput;
...
// const CHILI = "Чили";
// const CHILI_DELIVERY = 250;
// const AUSTRIA = "Австралия";
// const AUSTRIA_DELIVERY = 170;
// const INDIA = "Индия";
// const INDIA_DELIVERY = 80;
// const JAMAIKA = "Ямайка";
// const JAMAIKA_DELIVERY = 120;

// const userInput = prompt('What is your country?');
...
//   case AUSTRIA.toLowerCase():
//     alert(`Доставка в ${AUSTRIA} будет стоить ${AUSTRIA_DELIVERY} кредитов`);
//     break;
...
//     alert(`Доставка в ${JAMAIKA} будет стоить ${JAMAIKA_DELIVERY} кредитов`);
//     break;
